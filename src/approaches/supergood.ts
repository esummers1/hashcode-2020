...
export default class Supergood extends Approach {
  public apply(input: InputModel): SolutionModel {
    ...
    // Sort books by descending score, for each library
    remainingLibraries.forEach(library => {
      library.books.sort((a, b) => b.score - a.score);
    })
